...
let () =
   ...
   let stream =
      ...
      run (succ one)
      (fun b a -> (subtype expression33554963 (iqueryable33554759 b)) &&& (not_subtype a (vector33554435 a)) &&& (not_subtype expression33554963 (iqueryable33554759 b)) &&& (is_reference a))
