...
and is_reference a = 
  conde 
    ...
    ; (a === valuetype33554777)
    ; fresh (e) 
       (a === iequatable33554522 e)
    ; fresh (f) 
       (a === icomparable33554521 f)
...
let () =
   ...
   let stream =
      ...
      run (succ (succ one))
      (fun b c a -> (subtype b (iqueryable33554759 c)) &&& (not_subtype (array233554434 int3233554683) a) &&& (not_subtype b (iqueryable33554759 c)))
