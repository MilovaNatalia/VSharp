...
let () =
   ...
   let stream =
      ...
      run (succ one)
      (fun a b -> (not_subtype a (tuple33554528 a)) &&& (not_subtype b (tuple33554528 a)) &&& (not_subtype a (tuple33554528 (tuple33554528 a))) &&& (not_subtype b (tuple33554528 (tuple33554528 a))))
