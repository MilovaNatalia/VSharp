...
let () =
   ...
   let stream =
      ...
      (fun c e f d a b -> (subtype c e) &&& (subtype f e) &&& (subtype c ih33554443) &&& (subtype d ih33554443) &&& (subtype a b) &&& (subtype c b) &&& (not_subtype a b) &&& (not_subtype c b) &&& (not_subtype c ih33554443) &&& (not_subtype d ih33554443))
