...
let () =
   ...
   let stream =
      ...
      run (succ (succ one))
      (fun a b c -> (not_subtype a (tuple33554529 a b)) &&& (not_subtype c (tuple33554529 a b)) &&& (not_subtype a (tuple33554529 (tuple33554528 a) a)) &&& (not_subtype c (tuple33554529 (tuple33554528 a) a)))
