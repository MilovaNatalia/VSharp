...
let () =
   ...
   let stream =
      ...
      (fun a e c f d b -> (subtype a ih33554443) &&& (subtype e ih33554443) &&& (subtype c f) &&& (subtype a f) &&& (subtype d (vector33554435 b)) &&& (subtype a b) &&& (subtype c b) &&& (subtype d (array233554434 int3233554683)) &&& (not_subtype a b) &&& (not_subtype c b) &&& (not_subtype d (vector33554435 b)) &&& (not_subtype d (array233554434 int3233554683)))
