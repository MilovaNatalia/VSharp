...
let () =
   ...
   let stream =
      ...
      (fun c d e f a b -> (subtype c (mutualrec33554488 d e)) &&& (subtype f (mutualrec33554488 d e)) &&& (subtype d (rec33554487 e)) &&& (subtype e (rec33554487 d)) &&& (subtype d (rec33554487 e)) &&& (subtype e (rec33554487 d)) &&& (not_subtype a action33554497) &&& (not_subtype a (ienumerable33555622 a)) &&& (not_subtype b iserializable33556234) &&& (is_reference b))
