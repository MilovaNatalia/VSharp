...
let () =
   ...
   let stream =
      ...
      (fun b d a c e f g h i j k -> (subtype b (ia33554436 d)) &&& (subtype d (ia33554436 b)) &&& (not_subtype valuetype33554777 a) &&& (not_subtype b (ia33554436 b)) &&& (not_subtype c (ia33554436 b)) &&& (not_subtype d (ia33554436 d)) &&& (not_subtype e (ia33554436 d)) &&& (not_subtype f b) &&& (not_subtype g b) &&& (not_subtype f h) &&& (not_subtype g h) &&& (not_subtype a h) &&& (not_subtype i h) &&& (not_subtype j h) &&& (not_subtype k h) &&& (default_constructor a) &&& (is_reference j))
