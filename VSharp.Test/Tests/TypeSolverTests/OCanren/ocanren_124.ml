...
let () =
   ...
   let stream =
      ...
      run (succ one)
      (fun b a -> (subtype b action33554497) &&& (subtype (list33555631 a) (ienumerable33555622 b)) &&& (subtype a (ienumerable33555622 b)) &&& (subtype b (vector33554435 b)) &&& (not_subtype a action33554497) &&& (not_subtype a (ienumerable33555622 a)) &&& (not_subtype b iserializable33556234) &&& (not_subtype b (vector33554435 b)) &&& (is_reference b))
