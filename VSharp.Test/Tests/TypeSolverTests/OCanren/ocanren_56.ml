...
and is_reference a = 
  conde 
    ...
    ; (a === valuetype33554777)
    ; fresh (f) 
       (a === iequatable33554522 f)
    ; fresh (g) 
       (a === icomparable33554521 g)
...
let () =
   ...
   let stream =
      ...
      (fun b c d a -> (subtype b (tuple33554529 (tuple33554528 b) b)) &&& (subtype c (tuple33554529 (tuple33554528 b) b)) &&& (subtype b (tuple33554529 b d)) &&& (subtype c (tuple33554529 b d)) &&& (subtype (array233554434 int3233554683) a) &&& (not_subtype (array233554434 int3233554683) a))
