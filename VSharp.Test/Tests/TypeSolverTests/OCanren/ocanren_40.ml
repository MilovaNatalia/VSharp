...
let () =
   ...
   let stream =
      ...
      run (succ one)
      (fun b a -> (subtype b action33554497) &&& (subtype b (ienumerable33555622 b)) &&& (subtype a iserializable33556234) &&& (not_subtype a action33554497) &&& (not_subtype (list33555631 b) (ienumerable33555622 a)) &&& (not_subtype b (ienumerable33555622 a)) &&& (is_reference a))
