...
let () =
   ...
   let stream =
      ...
      run (succ (succ one))
      (fun a b c -> (not_subtype a (tuple33554529 (tuple33554528 a) a)) &&& (not_subtype b (tuple33554529 (tuple33554528 a) a)) &&& (not_subtype a (tuple33554529 a c)) &&& (not_subtype b (tuple33554529 a c)))
