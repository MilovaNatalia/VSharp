...
let () =
   ...
   let stream =
      ...
      (fun e f g h a b c d -> (subtype (ia33554436 e) f) &&& (subtype g f) &&& (subtype f (ia33554436 f)) &&& (subtype h (ia33554436 f)) &&& (not_subtype a m33554470) &&& (not_subtype b m33554470) &&& (not_subtype c n33554471) &&& (not_subtype d n33554471) &&& (not_subtype (ia33554436 e) f) &&& (not_subtype g f) &&& (not_subtype f (ia33554436 f)) &&& (not_subtype h (ia33554436 f)))
