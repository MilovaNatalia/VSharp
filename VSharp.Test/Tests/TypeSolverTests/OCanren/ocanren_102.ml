...
let () =
   ...
   let stream =
      ...
      (fun a b c d e f g h i j k -> (not_subtype a (ia33554436 a)) &&& (not_subtype b (ia33554436 a)) &&& (not_subtype valuetype33554777 c) &&& (not_subtype d (ia33554436 d)) &&& (not_subtype e (ia33554436 d)) &&& (not_subtype f a) &&& (not_subtype g a) &&& (not_subtype f h) &&& (not_subtype g h) &&& (not_subtype c h) &&& (not_subtype i h) &&& (not_subtype j h) &&& (not_subtype k h) &&& (not_subtype a (ia33554436 d)) &&& (not_subtype d (ia33554436 a)) &&& (not_subtype a (ia33554436 d)) &&& (not_subtype d (ia33554436 a)) &&& (default_constructor c) &&& (is_reference j))
