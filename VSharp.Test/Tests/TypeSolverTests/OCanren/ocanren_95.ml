...
and is_reference a = 
  conde 
    ...
    ; fresh (e) 
       (a === vector33554435 e)
    ; fresh (f) 
       (a === ireadonlycollection33555626 f)
    ; fresh (g) 
       (a === ienumerable33555622 g)
    ; fresh (h) 
       (a === ireadonlylist33555627 h)
    ; fresh (i) 
       (a === icollection33555619 i)
    ; fresh (j) 
       (a === ilist33555625 j)
    ; (a === ih33554443)
    ; (a === object33554493)
...
and not_subtype a b = 
  conde 
    ...
    ; fresh (c) 
       (a === istructuralequatable33555576) 
       (b === ilist33555625 c)
    ; (a === istructuralequatable33555576) &&& (b === ih33554443)
    ; fresh (c) 
       (a === istructuralcomparable33555577) 
       (b === array233554434 c)
    ...
    ; fresh (c) 
       (a === istructuralcomparable33555577) 
       (b === ilist33555625 c)
    ; (a === istructuralcomparable33555577) &&& (b === ih33554443)
    ; fresh (c) 
       (a === ienumerable33555569) 
       (b === array233554434 c)
    ...
    ; fresh (c) 
       (a === ienumerable33555569) 
       (b === ilist33555625 c)
    ; (a === ienumerable33555569) &&& (b === ih33554443)
    ; fresh (c) 
       (a === icollection33555565) 
       (b === array233554434 c)
    ...
    ; fresh (c) 
       (a === icollection33555565) 
       (b === ilist33555625 c)
    ; (a === icollection33555565) &&& (b === ih33554443)
    ; fresh (c) 
       (a === ilist33555573) 
       (b === array233554434 c)
    ...
    ; fresh (c) 
       (a === icloneable33554495) 
       (b === ilist33555625 c)
    ; (a === icloneable33554495) &&& (b === ih33554443)
    ; fresh (c) 
       (a === int3233554683) 
       (b === array233554434 c)
    ...
    ; fresh (c) 
       (a === ih33554443) 
       (b === array233554434 c)
    ; (a === ih33554443) &&& (b === array33554517)
    ; (a === ih33554443) &&& (b === istructuralequatable33555576)
    ; (a === ih33554443) &&& (b === istructuralcomparable33555577)
    ; (a === ih33554443) &&& (b === ienumerable33555569)
    ; (a === ih33554443) &&& (b === icollection33555565)
    ; (a === ih33554443) &&& (b === ilist33555573)
    ; (a === ih33554443) &&& (b === icloneable33554495)
...
let () =
   ...
   let stream =
      ...
      (fun a f c e b d -> (subtype a f) &&& (subtype c f) &&& (subtype e (vector33554435 f)) &&& (subtype e (array233554434 int3233554683)) &&& (not_subtype a ih33554443) &&& (not_subtype b ih33554443) &&& (not_subtype c d) &&& (not_subtype a d) &&& (not_subtype e (vector33554435 f)) &&& (not_subtype a f) &&& (not_subtype c f) &&& (not_subtype e (array233554434 int3233554683)))
