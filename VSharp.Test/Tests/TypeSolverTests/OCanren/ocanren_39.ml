...
let () =
   ...
   let stream =
      ...
      run (succ one)
      (fun b a -> (subtype b action33554497) &&& (subtype (list33555631 a) (ienumerable33555622 b)) &&& (subtype a (ienumerable33555622 b)) &&& (not_subtype a action33554497) &&& (not_subtype a (ienumerable33555622 a)) &&& (not_subtype b iserializable33556234) &&& (is_reference b))
