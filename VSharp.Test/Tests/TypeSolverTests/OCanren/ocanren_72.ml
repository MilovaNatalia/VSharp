...
let () =
   ...
   let stream =
      ...
      (fun e f a b c d -> (subtype e m33554470) &&& (subtype f n33554471) &&& (subtype a m33554470) &&& (subtype b m33554470) &&& (subtype c n33554471) &&& (subtype d n33554471) &&& (not_subtype a m33554470) &&& (not_subtype b m33554470) &&& (not_subtype c n33554471) &&& (not_subtype d n33554471))
