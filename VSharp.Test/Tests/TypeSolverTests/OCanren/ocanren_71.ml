...
let () =
   ...
   let stream =
      ...
      (fun c d e f a b -> (subtype c m33554470) &&& (subtype d m33554470) &&& (subtype e n33554471) &&& (subtype f n33554471) &&& (not_subtype a m33554470) &&& (not_subtype b n33554471) &&& (not_subtype c m33554470) &&& (not_subtype d m33554470) &&& (not_subtype e n33554471) &&& (not_subtype f n33554471))
