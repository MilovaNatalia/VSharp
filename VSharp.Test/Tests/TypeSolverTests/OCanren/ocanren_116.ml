...
let () =
   ...
   let stream =
      ...
      (fun e a b c d -> (subtype (vector33554435 e) e) &&& (subtype a (mutualrec33554488 b c)) &&& (subtype d (mutualrec33554488 b c)) &&& (not_subtype a (mutualrec33554488 b c)) &&& (not_subtype d (mutualrec33554488 b c)) &&& (not_subtype b (rec33554487 c)) &&& (not_subtype c (rec33554487 b)))
