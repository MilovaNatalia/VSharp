...
and is_reference a = (a === object33554493)
...
and not_subtype a b = failure
and subtype a b = (a === object33554493) &&& (b === object33554493)
end
...
let () =
   ...
   let stream =
      ...
      run (succ (succ one))
      (fun a b c -> (not_subtype a b) &&& (not_subtype c b))
