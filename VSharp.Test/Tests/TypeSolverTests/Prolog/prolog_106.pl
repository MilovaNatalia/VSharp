...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,func33554502(B,dictionary33555602(C,D))), not_subtype(func33554503(C,E,B),func33554503(C,func33554502(C,D),C)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['E =', E]))))).
