...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,action33554497), subtype(B,ienumerable33555622(B)), subtype(A,iserializable33556234), subtype(A,vector33554435(A)), not_subtype(A,action33554497), not_subtype(list33555631(B),ienumerable33555622(A)), not_subtype(B,ienumerable33555622(A)), not_subtype(A,vector33554435(A)), is_reference(A), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['A =', A]))))).
