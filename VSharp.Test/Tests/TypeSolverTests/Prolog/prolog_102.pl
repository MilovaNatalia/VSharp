...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,ia33554436(A)), not_subtype(B,ia33554436(A)), not_subtype(valuetype33554777,C), not_subtype(D,ia33554436(D)), not_subtype(E,ia33554436(D)), not_subtype(F,A), not_subtype(G,A), not_subtype(F,H), not_subtype(G,H), not_subtype(C,H), not_subtype(I,H), not_subtype(J,H), not_subtype(K,H), not_subtype(A,ia33554436(D)), not_subtype(D,ia33554436(A)), not_subtype(A,ia33554436(D)), not_subtype(D,ia33554436(A)), default_constructor(C), is_reference(J), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['G =', G]),format('~w ~w~n', ['H =', H]),format('~w ~w~n', ['I =', I]),format('~w ~w~n', ['J =', J]),format('~w ~w~n', ['K =', K]))))).
