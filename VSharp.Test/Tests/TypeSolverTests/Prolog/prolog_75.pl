...
not_subtype(ia33554436(_),ic33554438(_)).
...
not_subtype(ia33554436(_),m33554470).
not_subtype(ia33554436(_),n33554471).
...
not_subtype(ic33554438(_),ia33554436(_)).
...
not_subtype(m33554470,ia33554436(_)).
...
not_subtype(n33554471,ia33554436(_)).
...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(ia33554436(E),F), subtype(G,F), subtype(F,ia33554436(F)), subtype(H,ia33554436(F)), not_subtype(A,m33554470), not_subtype(B,m33554470), not_subtype(C,n33554471), not_subtype(D,n33554471), not_subtype(ia33554436(E),F), not_subtype(G,F), not_subtype(F,ia33554436(F)), not_subtype(H,ia33554436(F)), format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['G =', G]),format('~w ~w~n', ['H =', H]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]))))).
