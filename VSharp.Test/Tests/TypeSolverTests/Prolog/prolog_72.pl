...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(E,m33554470), subtype(F,n33554471), subtype(A,m33554470), subtype(B,m33554470), subtype(C,n33554471), subtype(D,n33554471), not_subtype(A,m33554470), not_subtype(B,m33554470), not_subtype(C,n33554471), not_subtype(D,n33554471), format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]))))).
