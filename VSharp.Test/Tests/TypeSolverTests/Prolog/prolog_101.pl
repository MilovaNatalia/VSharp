...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(A,ia33554436(A)), subtype(B,ia33554436(A)), subtype(valuetype33554777,C), subtype(D,ia33554436(D)), subtype(E,ia33554436(D)), subtype(F,A), subtype(G,A), subtype(F,H), subtype(G,H), subtype(C,H), subtype(I,H), subtype(J,H), subtype(K,H), subtype(A,ia33554436(D)), subtype(D,ia33554436(A)), subtype(A,ia33554436(D)), subtype(D,ia33554436(A)), default_constructor(C), is_reference(J), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['G =', G]),format('~w ~w~n', ['H =', H]),format('~w ~w~n', ['I =', I]),format('~w ~w~n', ['J =', J]),format('~w ~w~n', ['K =', K]))))).
