...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(A,tuple33554529(A,B)), subtype(C,tuple33554529(A,B)), subtype(A,tuple33554529(tuple33554528(A),A)), subtype(C,tuple33554529(tuple33554528(A),A)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
