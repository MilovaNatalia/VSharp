...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,rec33554487(C)), subtype(C,rec33554487(B)), subtype(E,action33554497), subtype(list33555631(F),ienumerable33555622(E)), subtype(F,ienumerable33555622(E)), not_subtype(A,mutualrec33554488(B,C)), not_subtype(D,mutualrec33554488(B,C)), not_subtype(E,action33554497), not_subtype(list33555631(F),ienumerable33555622(E)), not_subtype(F,ienumerable33555622(E)), is_reference(E), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['D =', D]))))).
