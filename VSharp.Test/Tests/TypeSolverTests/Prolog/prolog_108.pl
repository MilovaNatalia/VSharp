...
not_subtype(dictionary33555602(_,_),dogsdelegate33554494(_,_)).
...
not_subtype(dogsdelegate33554494(_,_),dictionary33555602(_,_)).
not_subtype(dogsdelegate33554494(_,_),func33554502(_,_)).
not_subtype(dogsdelegate33554494(_,_),func33554503(_,_,_)).
not_subtype(dogsdelegate33554494(_,_),icollection33555565).
not_subtype(dogsdelegate33554494(_,_),icollection33555619(_)).
not_subtype(dogsdelegate33554494(_,_),ideserializationcallback33556230).
not_subtype(dogsdelegate33554494(_,_),idictionary33555567).
not_subtype(dogsdelegate33554494(_,_),idictionary33555621(_,_)).
...
not_subtype(dogsdelegate33554494(_,_),ireadonlydictionary33555628(_,_)).
not_subtype(dogsdelegate33554494(_,_),keyvaluepair33555630(_,_)).
not_subtype(dogsdelegate33554494(_,_),valuetype33554777).
...
not_subtype(func33554502(_,_),dogsdelegate33554494(_,_)).
...
not_subtype(func33554503(_,_,_),dogsdelegate33554494(_,_)).
...
not_subtype(ideserializationcallback33556230,dogsdelegate33554494(_,_)).
...
not_subtype(idictionary33555567,dogsdelegate33554494(_,_)).
...
not_subtype(idictionary33555621(_,_),dogsdelegate33554494(_,_)).
...
not_subtype(ireadonlydictionary33555628(_,_),dogsdelegate33554494(_,_)).
...
not_subtype(keyvaluepair33555630(_,_),dogsdelegate33554494(_,_)).
...
not_subtype(valuetype33554777,dogsdelegate33554494(_,_)).
...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(D,func33554502(E,dictionary33555602(F,G))), subtype(func33554503(F,H,E),func33554503(F,func33554502(F,G),F)), subtype(A,dogsdelegate33554494(B,C)), not_subtype(A,dogsdelegate33554494(B,C)), format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['G =', G]),format('~w ~w~n', ['H =', H]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
