...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(C,ibox33554489(thing33554490)), not_subtype(A,iqueryable33554759(B)), not_subtype(C,ibox33554489(thing33554490)), format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
