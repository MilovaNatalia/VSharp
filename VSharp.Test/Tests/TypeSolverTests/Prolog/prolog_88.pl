...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(E,ik33554445), subtype(F,ik33554445), subtype(E,sc33554484), subtype(F,sc33554484), subtype(E,sb33554483), subtype(F,sb33554483), subtype(E,sa33554482), subtype(F,sa33554482), subtype(E,ia33554436(A)), subtype(F,ia33554436(A)), subtype(E,int3233554683), subtype(F,int3233554683), subtype(B,C), subtype(D,C), not_subtype(A,valuetype33554777), not_subtype(B,C), not_subtype(D,C), is_valuetype(A), default_constructor(A), format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]))))).
