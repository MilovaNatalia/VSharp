...
not_subtype(array233554434(_),ih33554443).
...
not_subtype(array33554517,ih33554443).
...
not_subtype(icloneable33554495,ih33554443).
...
not_subtype(icollection33555565,ih33554443).
...
not_subtype(icollection33555619(_),ih33554443).
...
not_subtype(ienumerable33555569,ih33554443).
...
not_subtype(ienumerable33555622(_),ih33554443).
...
not_subtype(ih33554443,array233554434(_)).
not_subtype(ih33554443,array33554517).
not_subtype(ih33554443,icloneable33554495).
not_subtype(ih33554443,icollection33555565).
not_subtype(ih33554443,icollection33555619(_)).
...
not_subtype(ih33554443,ienumerable33555569).
not_subtype(ih33554443,ienumerable33555622(_)).
not_subtype(ih33554443,iequatable33554522(_)).
not_subtype(ih33554443,iformattable33554672).
not_subtype(ih33554443,ilist33555573).
not_subtype(ih33554443,ilist33555625(_)).
not_subtype(ih33554443,int3233554683).
not_subtype(ih33554443,ireadonlycollection33555626(_)).
not_subtype(ih33554443,ireadonlylist33555627(_)).
not_subtype(ih33554443,istructuralcomparable33555577).
not_subtype(ih33554443,istructuralequatable33555576).
not_subtype(ih33554443,valuetype33554777).
not_subtype(ih33554443,vector33554435(_)).
...
not_subtype(ilist33555573,ih33554443).
...
not_subtype(ilist33555625(_),ih33554443).
...
not_subtype(ireadonlycollection33555626(_),ih33554443).
...
not_subtype(ireadonlylist33555627(_),ih33554443).
...
not_subtype(istructuralcomparable33555577,ih33554443).
...
not_subtype(istructuralequatable33555576,ih33554443).
...
not_subtype(vector33554435(_),ih33554443).
...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(A,ih33554443), subtype(E,ih33554443), subtype(C,F), subtype(A,F), subtype(D,vector33554435(B)), subtype(A,B), subtype(C,B), subtype(D,array233554434(int3233554683)), not_subtype(A,B), not_subtype(C,B), not_subtype(D,vector33554435(B)), not_subtype(D,array233554434(int3233554683)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['B =', B]))))).
