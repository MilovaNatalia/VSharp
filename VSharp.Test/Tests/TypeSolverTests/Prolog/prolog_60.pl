...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(array233554434(int3233554683),C), subtype(A,iqueryable33554759(B)), not_subtype(A,iqueryable33554759(B)), format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
