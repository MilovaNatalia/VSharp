...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,m33554470), subtype(C,n33554471), not_subtype(A,ibox33554489(thing33554490)), not_subtype(B,m33554470), not_subtype(C,n33554471), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]))))).
