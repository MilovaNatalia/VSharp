...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,action33554497), subtype(list33555631(A),ienumerable33555622(B)), subtype(A,ienumerable33555622(B)), not_subtype(A,action33554497), not_subtype(A,ienumerable33555622(A)), not_subtype(B,iserializable33556234), is_reference(B), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['A =', A]))))).
