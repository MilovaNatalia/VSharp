...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,sc33554484), not_subtype(B,sc33554484), not_subtype(A,ik33554445), not_subtype(B,ik33554445), not_subtype(A,sb33554483), not_subtype(B,sb33554483), not_subtype(A,sa33554482), not_subtype(B,sa33554482), not_subtype(A,ia33554436(C)), not_subtype(B,ia33554436(C)), not_subtype(A,int3233554683), not_subtype(B,int3233554683), not_subtype(C,valuetype33554777), not_subtype(C,valuetype33554777), is_valuetype(C), default_constructor(C), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
