...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(A,mutualrec33554488(B,C)), subtype(D,mutualrec33554488(B,C)), subtype(B,rec33554487(C)), subtype(C,rec33554487(B)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]))))).
