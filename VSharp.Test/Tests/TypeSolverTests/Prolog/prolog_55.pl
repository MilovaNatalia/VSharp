...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(array233554434(int3233554683),D), not_subtype(A,tuple33554529(tuple33554528(A),A)), not_subtype(B,tuple33554529(tuple33554528(A),A)), not_subtype(A,tuple33554529(A,C)), not_subtype(B,tuple33554529(A,C)), not_subtype(array233554434(int3233554683),D), format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
