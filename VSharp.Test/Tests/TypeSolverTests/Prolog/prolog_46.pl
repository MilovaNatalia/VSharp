...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,array33554517), not_subtype(B,array33554517), not_subtype(B,action33554497), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
