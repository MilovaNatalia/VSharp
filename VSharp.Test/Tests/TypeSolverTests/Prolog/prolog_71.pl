...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(C,m33554470), subtype(D,m33554470), subtype(E,n33554471), subtype(F,n33554471), not_subtype(A,m33554470), not_subtype(B,n33554471), not_subtype(C,m33554470), not_subtype(D,m33554470), not_subtype(E,n33554471), not_subtype(F,n33554471), format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
