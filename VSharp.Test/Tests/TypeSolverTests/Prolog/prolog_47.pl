...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(C,tuple33554528(tuple33554528(C))), subtype(A,tuple33554528(tuple33554528(C))), subtype(C,tuple33554528(C)), subtype(A,tuple33554528(C)), not_subtype(A,action33554497), not_subtype(B,array33554517), not_subtype(A,array33554517), not_subtype(C,tuple33554528(C)), not_subtype(A,tuple33554528(C)), not_subtype(C,tuple33554528(tuple33554528(C))), not_subtype(A,tuple33554528(tuple33554528(C))), format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
