...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(valuetype33554777,H), subtype(A,ia33554436(A)), subtype(I,ia33554436(A)), subtype(B,ia33554436(B)), subtype(J,ia33554436(B)), subtype(K,A), subtype(L,A), subtype(K,M), subtype(L,M), subtype(H,M), subtype(N,M), subtype(O,M), subtype(P,M), subtype(C,func33554502(D,dictionary33555602(E,F))), subtype(func33554503(E,G,D),func33554503(E,func33554502(E,F),E)), not_subtype(A,ia33554436(B)), not_subtype(B,ia33554436(A)), not_subtype(C,func33554502(D,dictionary33555602(E,F))), not_subtype(func33554503(E,G,D),func33554503(E,func33554502(E,F),E)), default_constructor(H), is_reference(O), format('~w ~w~n', ['H =', H]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['I =', I]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['J =', J]),format('~w ~w~n', ['K =', K]),format('~w ~w~n', ['L =', L]),format('~w ~w~n', ['M =', M]),format('~w ~w~n', ['N =', N]),format('~w ~w~n', ['O =', O]),format('~w ~w~n', ['P =', P]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['G =', G]))))).
