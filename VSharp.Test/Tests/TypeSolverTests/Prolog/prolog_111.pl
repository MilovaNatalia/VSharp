...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(vector33554435(D),D), not_subtype(A,dogsdelegate33554494(B,C)), not_subtype(vector33554435(D),D), format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
