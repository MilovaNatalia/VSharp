...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(E,action33554497), subtype(E,ienumerable33555622(E)), subtype(F,iserializable33556234), not_subtype(A,mutualrec33554488(B,C)), not_subtype(D,mutualrec33554488(B,C)), not_subtype(B,rec33554487(C)), not_subtype(C,rec33554487(B)), not_subtype(B,rec33554487(C)), not_subtype(C,rec33554487(B)), is_reference(F), format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['D =', D]))))).
