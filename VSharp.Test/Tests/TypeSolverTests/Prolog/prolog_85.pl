...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(A,sc33554484), subtype(B,sc33554484), subtype(A,ik33554445), subtype(B,ik33554445), subtype(A,sb33554483), subtype(B,sb33554483), subtype(A,sa33554482), subtype(B,sa33554482), subtype(A,ia33554436(C)), subtype(B,ia33554436(C)), subtype(A,int3233554683), subtype(B,int3233554683), subtype(C,valuetype33554777), subtype(C,valuetype33554777), is_valuetype(C), default_constructor(C), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
