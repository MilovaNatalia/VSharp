...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(A,F), subtype(C,F), subtype(E,vector33554435(F)), subtype(E,array233554434(int3233554683)), not_subtype(A,ih33554443), not_subtype(B,ih33554443), not_subtype(C,D), not_subtype(A,D), not_subtype(E,vector33554435(F)), not_subtype(A,F), not_subtype(C,F), not_subtype(E,array233554434(int3233554683)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['D =', D]))))).
