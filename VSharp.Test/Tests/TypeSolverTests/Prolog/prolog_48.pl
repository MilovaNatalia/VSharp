...
not_subtype(action33554497,icomparable33554520).
...
not_subtype(action33554497,ituple33556673).
not_subtype(action33554497,itupleinternal33554526).
not_subtype(action33554497,tuple33554528(_)).
...
not_subtype(delegate33554565,icomparable33554520).
...
not_subtype(delegate33554565,ituple33556673).
not_subtype(delegate33554565,itupleinternal33554526).
not_subtype(delegate33554565,multicastdelegate33554567).
not_subtype(delegate33554565,tuple33554528(_)).
...
not_subtype(icomparable33554520,action33554497).
not_subtype(icomparable33554520,array33554517).
not_subtype(icomparable33554520,delegate33554565).
...
not_subtype(icomparable33554520,iserializable33556234).
...
not_subtype(icomparable33554520,multicastdelegate33554567).
...
not_subtype(iserializable33556234,icomparable33554520).
...
not_subtype(iserializable33556234,ituple33556673).
not_subtype(iserializable33556234,itupleinternal33554526).
not_subtype(iserializable33556234,multicastdelegate33554567).
not_subtype(iserializable33556234,tuple33554528(_)).
...
not_subtype(ituple33556673,action33554497).
not_subtype(ituple33556673,array33554517).
not_subtype(ituple33556673,delegate33554565).
...
not_subtype(ituple33556673,iserializable33556234).
...
not_subtype(ituple33556673,multicastdelegate33554567).
not_subtype(ituple33556673,tuple33554528(_)).
not_subtype(itupleinternal33554526,action33554497).
not_subtype(itupleinternal33554526,array33554517).
not_subtype(itupleinternal33554526,delegate33554565).
...
not_subtype(itupleinternal33554526,iserializable33556234).
...
not_subtype(itupleinternal33554526,multicastdelegate33554567).
...
not_subtype(multicastdelegate33554567,icomparable33554520).
...
not_subtype(multicastdelegate33554567,ituple33556673).
not_subtype(multicastdelegate33554567,itupleinternal33554526).
not_subtype(multicastdelegate33554567,tuple33554528(_)).
...
not_subtype(tuple33554528(_),action33554497).
not_subtype(tuple33554528(_),array33554517).
not_subtype(tuple33554528(_),delegate33554565).
...
not_subtype(tuple33554528(_),iserializable33556234).
not_subtype(tuple33554528(_),multicastdelegate33554567).
...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,action33554497), subtype(C,array33554517), subtype(B,array33554517), subtype(A,tuple33554528(A)), subtype(B,tuple33554528(A)), subtype(A,tuple33554528(tuple33554528(A))), subtype(B,tuple33554528(tuple33554528(A))), not_subtype(A,tuple33554528(tuple33554528(A))), not_subtype(B,tuple33554528(tuple33554528(A))), not_subtype(A,tuple33554528(A)), not_subtype(B,tuple33554528(A)), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]))))).
