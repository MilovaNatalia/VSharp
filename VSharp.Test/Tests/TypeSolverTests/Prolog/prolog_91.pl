...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(E,F), subtype(A,F), subtype(A,ih33554443), subtype(D,ih33554443), not_subtype(A,B), not_subtype(C,B), not_subtype(A,ih33554443), not_subtype(D,ih33554443), not_subtype(E,F), not_subtype(A,F), format('~w ~w~n', ['E =', E]),format('~w ~w~n', ['F =', F]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
