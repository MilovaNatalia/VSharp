...
not_subtype(action33554497,vector33554435(_)).
...
not_subtype(array33554517,list33555631(_)).
...
not_subtype(istructuralcomparable33555577,list33555631(_)).
...
not_subtype(istructuralequatable33555576,list33555631(_)).
...
not_subtype(list33555631(_),array33554517).
...
not_subtype(list33555631(_),istructuralcomparable33555577).
not_subtype(list33555631(_),istructuralequatable33555576).
not_subtype(list33555631(_),multicastdelegate33554567).
not_subtype(list33555631(_),vector33554435(_)).
...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,action33554497), subtype(list33555631(A),ienumerable33555622(B)), subtype(A,ienumerable33555622(B)), subtype(B,vector33554435(B)), not_subtype(A,action33554497), not_subtype(A,ienumerable33555622(A)), not_subtype(B,iserializable33556234), not_subtype(B,vector33554435(B)), is_reference(B), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['A =', A]))))).
