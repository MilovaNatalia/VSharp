...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,m33554470), not_subtype(B,n33554471), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
