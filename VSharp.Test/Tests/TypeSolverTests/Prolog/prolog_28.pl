...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,vector33554435(C)), not_subtype(B,C), not_subtype(D,C), not_subtype(A,array233554434(int3233554683)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['D =', D]))))).
