...
not_subtype(array233554434(_),iqueryable33554758).
not_subtype(array233554434(_),iqueryable33554759(_)).
...
not_subtype(icomparable33554520,iqueryable33554758).
not_subtype(icomparable33554520,iqueryable33554759(_)).
...
not_subtype(icomparable33554521(_),iqueryable33554758).
not_subtype(icomparable33554521(_),iqueryable33554759(_)).
...
not_subtype(iconvertible33554691,iqueryable33554758).
not_subtype(iconvertible33554691,iqueryable33554759(_)).
...
not_subtype(iequatable33554522(_),iqueryable33554758).
not_subtype(iequatable33554522(_),iqueryable33554759(_)).
...
not_subtype(iformattable33554672,iqueryable33554758).
not_subtype(iformattable33554672,iqueryable33554759(_)).
...
not_subtype(int3233554683,iqueryable33554758).
not_subtype(int3233554683,iqueryable33554759(_)).
not_subtype(int3233554683,istructuralcomparable33555577).
not_subtype(int3233554683,istructuralequatable33555576).
not_subtype(iqueryable33554758,array233554434(_)).
...
not_subtype(iqueryable33554758,icomparable33554520).
not_subtype(iqueryable33554758,icomparable33554521(_)).
not_subtype(iqueryable33554758,iconvertible33554691).
not_subtype(iqueryable33554758,ienumerable33555622(_)).
not_subtype(iqueryable33554758,iequatable33554522(_)).
not_subtype(iqueryable33554758,iformattable33554672).
not_subtype(iqueryable33554758,ilist33555573).
not_subtype(iqueryable33554758,int3233554683).
...
not_subtype(iqueryable33554758,valuetype33554777).
not_subtype(iqueryable33554759(_),array233554434(_)).
...
not_subtype(iqueryable33554759(_),icomparable33554520).
not_subtype(iqueryable33554759(_),icomparable33554521(_)).
not_subtype(iqueryable33554759(_),iconvertible33554691).
not_subtype(iqueryable33554759(_),iequatable33554522(_)).
not_subtype(iqueryable33554759(_),iformattable33554672).
not_subtype(iqueryable33554759(_),ilist33555573).
not_subtype(iqueryable33554759(_),int3233554683).
...
not_subtype(iqueryable33554759(_),valuetype33554777).
...
not_subtype(valuetype33554777,iqueryable33554758).
not_subtype(valuetype33554777,iqueryable33554759(_)).
...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(B,iqueryable33554759(C)), not_subtype(array233554434(int3233554683),A), not_subtype(B,iqueryable33554759(C)), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]))))).
