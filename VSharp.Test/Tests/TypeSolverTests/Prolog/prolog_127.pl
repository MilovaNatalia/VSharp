...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(expression33554963,iqueryable33554759(B)), not_subtype(A,vector33554435(A)), not_subtype(expression33554963,iqueryable33554759(B)), is_reference(A), format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['A =', A]))))).
