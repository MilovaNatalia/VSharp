...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (subtype(D,tuple33554528(D)), subtype(C,tuple33554528(D)), subtype(D,tuple33554528(tuple33554528(D))), subtype(C,tuple33554528(tuple33554528(D))), subtype(A,tuple33554529(tuple33554528(A),A)), subtype(C,tuple33554529(tuple33554528(A),A)), subtype(A,tuple33554529(A,B)), subtype(C,tuple33554529(A,B)), not_subtype(A,tuple33554529(A,B)), not_subtype(C,tuple33554529(A,B)), not_subtype(A,tuple33554529(tuple33554528(A),A)), not_subtype(C,tuple33554529(tuple33554528(A),A)), format('~w ~w~n', ['D =', D]),format('~w ~w~n', ['C =', C]),format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]))))).
