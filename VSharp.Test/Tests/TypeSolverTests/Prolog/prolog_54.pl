...
go :- set_prolog_flag(occurs_check, true), time(call_with_time_limit(20, limit(1, (not_subtype(A,tuple33554529(A,B)), not_subtype(C,tuple33554529(A,B)), not_subtype(A,tuple33554529(tuple33554528(A),A)), not_subtype(C,tuple33554529(tuple33554528(A),A)), format('~w ~w~n', ['A =', A]),format('~w ~w~n', ['B =', B]),format('~w ~w~n', ['C =', C]))))).
