...
(assert(forall((b Type) (a Type)) (=> (or (and (is_reference b) (subtype b a)) (and (= b a) (is_valuetype b))) (contravariant_subtype a b))))
(assert(forall((b Type) (a Type)) (=> (or (and (not(= b a)) (is_valuetype b)) (and (is_reference b) (not(subtype b a)))) (not(contravariant_subtype a b)))))
...
(assert(forall((a Type) (b Type)) (not (and (subtype a (tuple33554528 (tuple33554528 a))) (subtype b (tuple33554528 (tuple33554528 a))) (subtype a (tuple33554528 a)) (subtype b (tuple33554528 a))))))
(check-sat)
(get-model)
