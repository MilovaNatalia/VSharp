...
(assert(forall((c Type) (d Type) (b Type) (a Type)) (not (and (subtype c (tuple33554529 c d)) (subtype b (tuple33554529 c d)) (subtype c (tuple33554529 (tuple33554528 c) c)) (subtype b (tuple33554529 (tuple33554528 c) c)) (not(subtype a (tuple33554528 a))) (not(subtype b (tuple33554528 a))) (not(subtype a (tuple33554528 (tuple33554528 a)))) (not(subtype b (tuple33554528 (tuple33554528 a)))) (not(subtype c (tuple33554529 (tuple33554528 c) c))) (not(subtype b (tuple33554529 (tuple33554528 c) c))) (not(subtype c (tuple33554529 c d))) (not(subtype b (tuple33554529 c d)))))))
(check-sat)
(get-model)
