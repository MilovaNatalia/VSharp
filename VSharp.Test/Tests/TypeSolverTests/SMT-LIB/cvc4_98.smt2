...
(assert(forall((a Type) (b Type) (c Type) (d Type)) (not (and (not(subtype a b)) (not(subtype c b)) (not(subtype d (vector33554435 b))) (not(subtype d (array233554434 int3233554683)))))))
(check-sat)
(get-model)
