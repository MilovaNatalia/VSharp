...
(assert(forall((d Type) (c Type) (a Type) (b Type)) (not (and (subtype d (tuple33554528 d)) (subtype c (tuple33554528 d)) (subtype d (tuple33554528 (tuple33554528 d))) (subtype c (tuple33554528 (tuple33554528 d))) (subtype a (tuple33554529 (tuple33554528 a) a)) (subtype c (tuple33554529 (tuple33554528 a) a)) (subtype a (tuple33554529 a b)) (subtype c (tuple33554529 a b)) (not(subtype a (tuple33554529 a b))) (not(subtype c (tuple33554529 a b))) (not(subtype a (tuple33554529 (tuple33554528 a) a))) (not(subtype c (tuple33554529 (tuple33554528 a) a)))))))
(check-sat)
(get-model)
