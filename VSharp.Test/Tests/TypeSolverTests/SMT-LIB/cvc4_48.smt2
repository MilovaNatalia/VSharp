...
(assert(forall((b Type) (c Type) (a Type)) (not (and (subtype b action33554497) (subtype c array33554517) (subtype b array33554517) (subtype a (tuple33554528 a)) (subtype b (tuple33554528 a)) (subtype a (tuple33554528 (tuple33554528 a))) (subtype b (tuple33554528 (tuple33554528 a))) (not(subtype a (tuple33554528 (tuple33554528 a)))) (not(subtype b (tuple33554528 (tuple33554528 a)))) (not(subtype a (tuple33554528 a))) (not(subtype b (tuple33554528 a)))))))
(check-sat)
(get-model)
