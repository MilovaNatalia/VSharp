...
(assert(forall((a Type) (f Type) (c Type) (e Type) (b Type) (d Type)) (not (and (subtype a f) (subtype c f) (subtype e (vector33554435 f)) (subtype e (array233554434 int3233554683)) (not(subtype a ih33554443)) (not(subtype b ih33554443)) (not(subtype c d)) (not(subtype a d)) (not(subtype e (vector33554435 f))) (not(subtype a f)) (not(subtype c f)) (not(subtype e (array233554434 int3233554683)))))))
(check-sat)
(get-model)
