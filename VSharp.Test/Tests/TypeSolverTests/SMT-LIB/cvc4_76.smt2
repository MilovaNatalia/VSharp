...
(assert(forall((e Type) (f Type) (g Type) (h Type) (a Type) (b Type) (c Type) (d Type)) (not (and (subtype e m33554470) (subtype f m33554470) (subtype g n33554471) (subtype h n33554471) (subtype (ia33554436 a) b) (subtype c b) (subtype b (ia33554436 b)) (subtype d (ia33554436 b)) (not(subtype (ia33554436 a) b)) (not(subtype c b)) (not(subtype b (ia33554436 b))) (not(subtype d (ia33554436 b)))))))
(check-sat)
(get-model)
