...
(assert(forall((g Type) (f Type) (e Type) (h Type) (a Type) (b Type) (c Type) (d Type)) (not (and (subtype g (ia33554436 f)) (subtype e (ia33554436 f)) (subtype g (ia33554436 h33554464)) (subtype h (ia33554436 i33554465)) (not(subtype (ia33554436 a) b)) (not(subtype c b)) (not(subtype b (ia33554436 b))) (not(subtype d (ia33554436 b))) (not(subtype e (ia33554436 f))) (not(subtype g (ia33554436 h33554464))) (not(subtype g (ia33554436 f))) (not(subtype h (ia33554436 i33554465)))))))
(check-sat)
(get-model)
