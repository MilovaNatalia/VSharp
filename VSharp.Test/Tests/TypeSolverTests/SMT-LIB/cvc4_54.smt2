...
(assert(forall((a Type) (b Type) (c Type)) (not (and (not(subtype a (tuple33554529 a b))) (not(subtype c (tuple33554529 a b))) (not(subtype a (tuple33554529 (tuple33554528 a) a))) (not(subtype c (tuple33554529 (tuple33554528 a) a)))))))
(check-sat)
(get-model)
