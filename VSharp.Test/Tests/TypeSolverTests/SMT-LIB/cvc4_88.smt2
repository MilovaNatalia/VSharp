...
(assert(forall((e Type) (f Type) (a Type) (b Type) (c Type) (d Type)) (not (and (subtype e ik33554445) (subtype f ik33554445) (subtype e sc33554484) (subtype f sc33554484) (subtype e sb33554483) (subtype f sb33554483) (subtype e sa33554482) (subtype f sa33554482) (subtype e (ia33554436 a)) (subtype f (ia33554436 a)) (subtype e int3233554683) (subtype f int3233554683) (subtype b c) (subtype d c) (not(subtype a valuetype33554777)) (not(subtype b c)) (not(subtype d c)) (is_valuetype a) (default_constructor a)))))
(check-sat)
(get-model)
