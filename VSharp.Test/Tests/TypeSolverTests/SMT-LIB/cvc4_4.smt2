...
(assert(forall((a Type) (b Type)) (not (and (not(subtype a (tuple33554528 a))) (not(subtype b (tuple33554528 a))) (not(subtype a (tuple33554528 (tuple33554528 a)))) (not(subtype b (tuple33554528 (tuple33554528 a))))))))
(check-sat)
(get-model)
