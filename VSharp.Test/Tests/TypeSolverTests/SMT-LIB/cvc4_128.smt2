...
(assert(forall((b Type) (a Type)) (not (and (subtype b (vector33554435 b)) (subtype expression33554963 (iqueryable33554759 a)) (not(subtype expression33554963 (iqueryable33554759 a))) (is_reference b)))))
(check-sat)
(get-model)
