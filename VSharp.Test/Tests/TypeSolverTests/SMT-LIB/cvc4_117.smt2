...
(assert(forall((c Type) (d Type) (e Type) (f Type) (a Type) (b Type)) (not (and (subtype c (mutualrec33554488 d e)) (subtype f (mutualrec33554488 d e)) (subtype d (rec33554487 e)) (subtype e (rec33554487 d)) (subtype d (rec33554487 e)) (subtype e (rec33554487 d)) (not(subtype a action33554497)) (not(subtype a (ienumerable33555622 a))) (not(subtype b iserializable33556234)) (is_reference b)))))
(check-sat)
(get-model)
