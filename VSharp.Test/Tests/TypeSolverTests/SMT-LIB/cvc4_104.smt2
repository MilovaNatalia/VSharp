...
(assert(forall((h Type) (a Type) (i Type) (b Type) (j Type) (k Type) (l Type) (m Type) (n Type) (o Type) (p Type) (c Type) (d Type) (e Type) (f Type) (g Type)) (not (and (subtype valuetype33554777 h) (subtype a (ia33554436 a)) (subtype i (ia33554436 a)) (subtype b (ia33554436 b)) (subtype j (ia33554436 b)) (subtype k a) (subtype l a) (subtype k m) (subtype l m) (subtype h m) (subtype n m) (subtype o m) (subtype p m) (subtype c (func33554502 d (dictionary33555602 e f))) (subtype (func33554503 e g d) (func33554503 e (func33554502 e f) e)) (not(subtype a (ia33554436 b))) (not(subtype b (ia33554436 a))) (not(subtype c (func33554502 d (dictionary33555602 e f)))) (not(subtype (func33554503 e g d) (func33554503 e (func33554502 e f) e))) (default_constructor h) (is_reference o)))))
(check-sat)
(get-model)
