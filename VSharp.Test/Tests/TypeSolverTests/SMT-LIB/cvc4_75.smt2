...
(assert(forall((a Type) (b Type)) (not(subtype (ia33554436 a) (ic33554438 b)))))
(assert(forall((a Type) (b Type)) (not(subtype (ic33554438 a) (ia33554436 b)))))
...
(assert(forall((a Type)) (not(subtype (ia33554436 a) m33554470))))
(assert(forall((a Type)) (not(subtype (ia33554436 a) n33554471))))
...
(assert(forall((a Type)) (not(subtype m33554470 (ia33554436 a)))))
(assert(forall((a Type)) (not(subtype n33554471 (ia33554436 a)))))
...
(assert(forall((e Type) (f Type) (g Type) (h Type) (a Type) (b Type) (c Type) (d Type)) (not (and (subtype (ia33554436 e) f) (subtype g f) (subtype f (ia33554436 f)) (subtype h (ia33554436 f)) (not(subtype a m33554470)) (not(subtype b m33554470)) (not(subtype c n33554471)) (not(subtype d n33554471)) (not(subtype (ia33554436 e) f)) (not(subtype g f)) (not(subtype f (ia33554436 f))) (not(subtype h (ia33554436 f)))))))
(check-sat)
(get-model)
