...
(assert(forall((b Type) (c Type) (a Type) (d Type)) (not (and (subtype b (rec33554487 c)) (subtype c (rec33554487 b)) (not(subtype a (mutualrec33554488 b c))) (not(subtype d (mutualrec33554488 b c)))))))
(check-sat)
(get-model)
