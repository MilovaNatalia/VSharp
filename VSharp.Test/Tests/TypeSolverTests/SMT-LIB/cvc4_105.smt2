...
(assert(forall((a Type) (b Type) (c Type) (d Type) (e Type)) (not (and (subtype a (func33554502 b (dictionary33555602 c d))) (subtype (func33554503 c e b) (func33554503 c (func33554502 c d) c))))))
(check-sat)
(get-model)
