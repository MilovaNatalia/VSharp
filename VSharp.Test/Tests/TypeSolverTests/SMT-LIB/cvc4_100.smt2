...
(assert(forall((l Type) (n Type) (m Type) (o Type) (c Type) (a Type) (b Type) (d Type) (e Type) (f Type) (g Type) (h Type) (i Type) (j Type) (k Type)) (not (and (subtype l (vector33554435 n)) (subtype m n) (subtype o n) (subtype l (array233554434 int3233554683)) (subtype valuetype33554777 c) (subtype a (ia33554436 a)) (subtype b (ia33554436 a)) (subtype d (ia33554436 d)) (subtype e (ia33554436 d)) (subtype f a) (subtype g a) (subtype f h) (subtype g h) (subtype c h) (subtype i h) (subtype j h) (subtype k h) (not(subtype a (ia33554436 a))) (not(subtype b (ia33554436 a))) (not(subtype valuetype33554777 c)) (not(subtype d (ia33554436 d))) (not(subtype e (ia33554436 d))) (not(subtype f a)) (not(subtype g a)) (not(subtype f h)) (not(subtype g h)) (not(subtype c h)) (not(subtype i h)) (not(subtype j h)) (not(subtype k h)) (not(subtype a (ia33554436 d))) (not(subtype d (ia33554436 a))) (default_constructor c) (is_reference j)))))
(check-sat)
(get-model)
