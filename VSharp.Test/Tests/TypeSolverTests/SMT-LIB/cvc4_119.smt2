...
(assert(forall((b Type) (c Type) (e Type) (f Type) (a Type) (d Type)) (not (and (subtype b (rec33554487 c)) (subtype c (rec33554487 b)) (subtype e action33554497) (subtype (list33555631 f) (ienumerable33555622 e)) (subtype f (ienumerable33555622 e)) (not(subtype a (mutualrec33554488 b c))) (not(subtype d (mutualrec33554488 b c))) (not(subtype e action33554497)) (not(subtype (list33555631 f) (ienumerable33555622 e))) (not(subtype f (ienumerable33555622 e))) (is_reference e)))))
(check-sat)
(get-model)
