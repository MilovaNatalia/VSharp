...
(assert(forall((a Type) (b Type) (c Type) (d Type)) (not(subtype (func33554503 a b c) (ia33554436 d)))))
...
(assert(forall((a Type) (b Type) (c Type) (d Type)) (not(subtype (ia33554436 a) (func33554503 b c d)))))
...
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (dictionary33555602 a b) (ia33554436 c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (func33554502 a b) (ia33554436 c)))))
...
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ia33554436 a) (dictionary33555602 b c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ia33554436 a) (func33554502 b c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ia33554436 a) (idictionary33555621 b c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ia33554436 a) (ireadonlydictionary33555628 b c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ia33554436 a) (keyvaluepair33555630 b c)))))
...
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (idictionary33555621 a b) (ia33554436 c)))))
...
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ireadonlydictionary33555628 a b) (ia33554436 c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (ireadonlydictionary33555628 a b) (icollection33555619 c)))))
(assert(forall((a Type) (b Type) (c Type)) (not(subtype (keyvaluepair33555630 a b) (ia33554436 c)))))
...
(assert(forall((a Type)) (not(subtype (ia33554436 a) delegate33554565))))
...
(assert(forall((a Type)) (not(subtype (ia33554436 a) ideserializationcallback33556230))))
(assert(forall((a Type)) (not(subtype (ia33554436 a) idictionary33555567))))
(assert(forall((a Type)) (not(subtype (ia33554436 a) ienumerable33555569))))
(assert(forall((a Type)) (not(subtype (ia33554436 a) iserializable33556234))))
(assert(forall((a Type)) (not(subtype (ia33554436 a) multicastdelegate33554567))))
...
(assert(forall((a Type)) (not(subtype delegate33554565 (ia33554436 a)))))
...
(assert(forall((a Type)) (not(subtype ideserializationcallback33556230 (ia33554436 a)))))
...
(assert(forall((a Type)) (not(subtype idictionary33555567 (ia33554436 a)))))
...
(assert(forall((a Type)) (not(subtype iserializable33556234 (ia33554436 a)))))
...
(assert(forall((a Type)) (not(subtype multicastdelegate33554567 (ia33554436 a)))))
...
(assert(forall((b Type) (d Type) (l Type) (m Type) (n Type) (o Type) (p Type) (a Type) (c Type) (e Type) (f Type) (g Type) (h Type) (i Type) (j Type) (k Type)) (not (and (subtype b (ia33554436 d)) (subtype d (ia33554436 b)) (subtype l (func33554502 m (dictionary33555602 n o))) (subtype (func33554503 n p m) (func33554503 n (func33554502 n o) n)) (not(subtype valuetype33554777 a)) (not(subtype b (ia33554436 b))) (not(subtype c (ia33554436 b))) (not(subtype d (ia33554436 d))) (not(subtype e (ia33554436 d))) (not(subtype f b)) (not(subtype g b)) (not(subtype f h)) (not(subtype g h)) (not(subtype a h)) (not(subtype i h)) (not(subtype j h)) (not(subtype k h)) (not(subtype l (func33554502 m (dictionary33555602 n o)))) (not(subtype (func33554503 n p m) (func33554503 n (func33554502 n o) n))) (default_constructor a) (is_reference j)))))
(check-sat)
(get-model)
