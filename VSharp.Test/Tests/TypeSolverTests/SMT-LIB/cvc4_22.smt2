...
(assert(forall((c Type) (a Type) (b Type)) (not (and (subtype c valuetype33554777) (not(subtype a ik33554445)) (not(subtype b ik33554445)) (not(subtype a sc33554484)) (not(subtype b sc33554484)) (not(subtype a sb33554483)) (not(subtype b sb33554483)) (not(subtype a sa33554482)) (not(subtype b sa33554482)) (not(subtype a (ia33554436 c))) (not(subtype b (ia33554436 c))) (not(subtype a int3233554683)) (not(subtype b int3233554683)) (is_valuetype c) (default_constructor c)))))
(check-sat)
(get-model)
