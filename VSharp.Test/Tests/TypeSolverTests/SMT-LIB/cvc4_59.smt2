...
(assert(forall((a Type) (b Type)) (not(subtype (array233554434 a) (iqueryable33554759 b)))))
...
(assert(forall((a Type) (b Type)) (not(subtype (icomparable33554521 a) (iqueryable33554759 b)))))
...
(assert(forall((a Type) (b Type)) (not(subtype (iequatable33554522 a) (iqueryable33554759 b)))))
(assert(forall((a Type) (b Type)) (not(subtype (iqueryable33554759 a) (array233554434 b)))))
(assert(forall((a Type) (b Type)) (not(subtype (iqueryable33554759 a) (icomparable33554521 b)))))
(assert(forall((a Type) (b Type)) (not(subtype (iqueryable33554759 a) (iequatable33554522 b)))))
...
(assert(forall((a Type)) (not(subtype (array233554434 a) iqueryable33554758))))
...
(assert(forall((a Type)) (not(subtype (icomparable33554521 a) iqueryable33554758))))
...
(assert(forall((a Type)) (not(subtype (iequatable33554522 a) iqueryable33554758))))
...
(assert(forall((a Type)) (not(subtype (iqueryable33554759 a) icomparable33554520))))
(assert(forall((a Type)) (not(subtype (iqueryable33554759 a) iconvertible33554691))))
(assert(forall((a Type)) (not(subtype (iqueryable33554759 a) iformattable33554672))))
(assert(forall((a Type)) (not(subtype (iqueryable33554759 a) ilist33555573))))
(assert(forall((a Type)) (not(subtype (iqueryable33554759 a) int3233554683))))
...
(assert(forall((a Type)) (not(subtype (iqueryable33554759 a) valuetype33554777))))
...
(assert(forall((a Type)) (not(subtype icomparable33554520 (iqueryable33554759 a)))))
...
(assert(forall((a Type)) (not(subtype iconvertible33554691 (iqueryable33554759 a)))))
...
(assert(forall((a Type)) (not(subtype iformattable33554672 (iqueryable33554759 a)))))
...
(assert(forall((a Type)) (not(subtype int3233554683 (iqueryable33554759 a)))))
(assert(forall((a Type)) (not(subtype iqueryable33554758 (array233554434 a)))))
(assert(forall((a Type)) (not(subtype iqueryable33554758 (icomparable33554521 a)))))
(assert(forall((a Type)) (not(subtype iqueryable33554758 (ienumerable33555622 a)))))
(assert(forall((a Type)) (not(subtype iqueryable33554758 (iequatable33554522 a)))))
...
(assert(forall((a Type)) (not(subtype valuetype33554777 (iqueryable33554759 a)))))
...
(assert(not(subtype icomparable33554520 iqueryable33554758)))
...
(assert(not(subtype iconvertible33554691 iqueryable33554758)))
...
(assert(not(subtype iformattable33554672 iqueryable33554758)))
...
(assert(not(subtype int3233554683 iqueryable33554758)))
...
(assert(not(subtype iqueryable33554758 icomparable33554520)))
(assert(not(subtype iqueryable33554758 iconvertible33554691)))
(assert(not(subtype iqueryable33554758 iformattable33554672)))
(assert(not(subtype iqueryable33554758 ilist33555573)))
(assert(not(subtype iqueryable33554758 int3233554683)))
...
(assert(not(subtype iqueryable33554758 valuetype33554777)))
...
(assert(not(subtype valuetype33554777 iqueryable33554758)))
...
(assert(forall((b Type) (c Type) (a Type)) (not (and (subtype b (iqueryable33554759 c)) (not(subtype (array233554434 int3233554683) a)) (not(subtype b (iqueryable33554759 c)))))))
(check-sat)
(get-model)
