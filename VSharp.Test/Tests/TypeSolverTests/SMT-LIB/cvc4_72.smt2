...
(assert(forall((e Type) (f Type) (a Type) (b Type) (c Type) (d Type)) (not (and (subtype e m33554470) (subtype f n33554471) (subtype a m33554470) (subtype b m33554470) (subtype c n33554471) (subtype d n33554471) (not(subtype a m33554470)) (not(subtype b m33554470)) (not(subtype c n33554471)) (not(subtype d n33554471))))))
(check-sat)
(get-model)
