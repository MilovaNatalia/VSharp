...
(assert(forall((b Type) (a Type)) (not (and (subtype b action33554497) (subtype (list33555631 a) (ienumerable33555622 b)) (subtype a (ienumerable33555622 b)) (not(subtype a action33554497)) (not(subtype a (ienumerable33555622 a))) (not(subtype b iserializable33556234)) (is_reference b)))))
(check-sat)
(get-model)
