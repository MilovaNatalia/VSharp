...
(assert(forall((b Type) (a Type)) (not (and (subtype b action33554497) (subtype b (ienumerable33555622 b)) (subtype a iserializable33556234) (not(subtype a action33554497)) (not(subtype (list33555631 b) (ienumerable33555622 a))) (not(subtype b (ienumerable33555622 a))) (is_reference a)))))
(check-sat)
(get-model)
