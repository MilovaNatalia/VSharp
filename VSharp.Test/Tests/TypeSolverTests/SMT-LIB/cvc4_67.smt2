...
(assert(forall((a Type) (b Type)) (not(subtype (ibox33554489 a) (ic33554438 b)))))
(assert(forall((a Type) (b Type)) (not(subtype (ic33554438 a) (ibox33554489 b)))))
...
(assert(forall((a Type)) (not(subtype (ibox33554489 a) a33554459))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) b33554460))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) c33554461))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) e33554463))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) ie33554440))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) if33554441))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) ig33554442))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) ih33554443))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) ik33554445))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) iq33554451))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) k33554466))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) m33554470))))
(assert(forall((a Type)) (not(subtype (ibox33554489 a) n33554471))))
...
(assert(forall((a Type)) (not(subtype (ic33554438 a) thing33554490))))
(assert(forall((a Type)) (not(subtype a33554459 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype a33554459 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype b33554460 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype b33554460 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype c33554461 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype c33554461 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype e33554463 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype e33554463 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype ie33554440 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype ie33554440 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype if33554441 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype if33554441 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype ig33554442 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype ig33554442 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype ik33554445 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype ik33554445 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype iq33554451 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype iq33554451 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype k33554466 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype k33554466 (ic33554438 a)))))
(assert(forall((a Type)) (not(subtype m33554470 (ibox33554489 a)))))
(assert(forall((a Type)) (not(subtype n33554471 (ibox33554489 a)))))
...
(assert(forall((a Type)) (not(subtype thing33554490 (ic33554438 a)))))
...
(assert(not(subtype a33554459 thing33554490)))
...
(assert(not(subtype b33554460 thing33554490)))
...
(assert(not(subtype ie33554440 thing33554490)))
...
(assert(not(subtype if33554441 thing33554490)))
...
(assert(not(subtype ig33554442 thing33554490)))
...
(assert(not(subtype ih33554443 thing33554490)))
...
(assert(not(subtype ik33554445 thing33554490)))
...
(assert(not(subtype iq33554451 thing33554490)))
(assert(not(subtype k33554466 m33554470)))
(assert(not(subtype k33554466 n33554471)))
(assert(not(subtype k33554466 thing33554490)))
...
(assert(not(subtype m33554470 thing33554490)))
...
(assert(not(subtype n33554471 thing33554490)))
...
(assert(not(subtype thing33554490 a33554459)))
(assert(not(subtype thing33554490 b33554460)))
(assert(not(subtype thing33554490 c33554461)))
(assert(not(subtype thing33554490 e33554463)))
(assert(not(subtype thing33554490 ie33554440)))
(assert(not(subtype thing33554490 if33554441)))
(assert(not(subtype thing33554490 ig33554442)))
(assert(not(subtype thing33554490 ih33554443)))
(assert(not(subtype thing33554490 ik33554445)))
(assert(not(subtype thing33554490 iq33554451)))
(assert(not(subtype thing33554490 k33554466)))
(assert(not(subtype thing33554490 m33554470)))
(assert(not(subtype thing33554490 n33554471)))
...
(assert(forall((b Type) (c Type) (a Type)) (not (and (subtype b m33554470) (subtype c n33554471) (not(subtype a (ibox33554489 thing33554490))) (not(subtype b m33554470)) (not(subtype c n33554471))))))
(check-sat)
(get-model)
