...
(assert(forall((f Type) (g Type) (h Type) (a Type) (b Type) (c Type) (d Type) (e Type)) (not (and (subtype f (dogsdelegate33554494 g h)) (not(subtype a (func33554502 b (dictionary33555602 c d)))) (not(subtype (func33554503 c e b) (func33554503 c (func33554502 c d) c))) (not(subtype f (dogsdelegate33554494 g h)))))))
(check-sat)
(get-model)
