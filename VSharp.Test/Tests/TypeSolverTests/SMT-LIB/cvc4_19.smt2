...
(assert(forall((a Type) (b Type) (c Type) (d Type)) (not (and (subtype a (ia33554436 b)) (subtype c (ia33554436 b)) (subtype a (ia33554436 h33554464)) (subtype d (ia33554436 i33554465))))))
(check-sat)
(get-model)
