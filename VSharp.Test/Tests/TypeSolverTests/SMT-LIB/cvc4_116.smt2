...
(assert(forall((e Type) (a Type) (b Type) (c Type) (d Type)) (not (and (subtype (vector33554435 e) e) (subtype a (mutualrec33554488 b c)) (subtype d (mutualrec33554488 b c)) (not(subtype a (mutualrec33554488 b c))) (not(subtype d (mutualrec33554488 b c))) (not(subtype b (rec33554487 c))) (not(subtype c (rec33554487 b)))))))
(check-sat)
(get-model)
