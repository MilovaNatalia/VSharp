...
(assert(forall((e Type) (f Type) (a Type) (d Type) (b Type) (c Type)) (not (and (subtype e f) (subtype a f) (subtype a ih33554443) (subtype d ih33554443) (not(subtype a b)) (not(subtype c b)) (not(subtype a ih33554443)) (not(subtype d ih33554443)) (not(subtype e f)) (not(subtype a f))))))
(check-sat)
(get-model)
