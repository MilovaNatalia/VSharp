...
(assert(forall((d Type) (e Type) (f Type) (g Type) (a Type) (b Type) (c Type)) (not (and (subtype d (ia33554436 e)) (subtype f (ia33554436 h33554464)) (subtype f (ia33554436 e)) (subtype g (ia33554436 i33554465)) (subtype a ik33554445) (subtype b ik33554445) (subtype a sc33554484) (subtype b sc33554484) (subtype a sb33554483) (subtype b sb33554483) (subtype a sa33554482) (subtype b sa33554482) (subtype a (ia33554436 c)) (subtype b (ia33554436 c)) (subtype a int3233554683) (subtype b int3233554683) (not(subtype a sc33554484)) (not(subtype b sc33554484)) (not(subtype a ik33554445)) (not(subtype b ik33554445)) (not(subtype a sb33554483)) (not(subtype b sb33554483)) (not(subtype a sa33554482)) (not(subtype b sa33554482)) (not(subtype a (ia33554436 c))) (not(subtype b (ia33554436 c))) (not(subtype a int3233554683)) (not(subtype b int3233554683)) (not(subtype c valuetype33554777)) (is_valuetype c) (default_constructor c)))))
(check-sat)
(get-model)
