...
(assert(forall((a Type) (b Type) (c Type) (d Type)) (not (and (not(subtype a (ia33554436 b))) (not(subtype c (ia33554436 h33554464))) (not(subtype c (ia33554436 b))) (not(subtype d (ia33554436 i33554465)))))))
(check-sat)
(get-model)
