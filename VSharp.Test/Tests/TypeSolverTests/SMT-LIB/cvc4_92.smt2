...
(assert(forall((c Type) (e Type) (f Type) (d Type) (a Type) (b Type)) (not (and (subtype c e) (subtype f e) (subtype c ih33554443) (subtype d ih33554443) (subtype a b) (subtype c b) (not(subtype a b)) (not(subtype c b)) (not(subtype c ih33554443)) (not(subtype d ih33554443))))))
(check-sat)
(get-model)
