...
(assert(forall((c Type) (a Type) (b Type)) (not (and (subtype c (ibox33554489 thing33554490)) (not(subtype a (iqueryable33554759 b))) (not(subtype c (ibox33554489 thing33554490)))))))
(check-sat)
(get-model)
