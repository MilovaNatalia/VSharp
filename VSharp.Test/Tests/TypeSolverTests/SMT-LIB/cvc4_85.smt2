...
(assert(forall((a Type) (b Type) (c Type)) (not (and (subtype a sc33554484) (subtype b sc33554484) (subtype a ik33554445) (subtype b ik33554445) (subtype a sb33554483) (subtype b sb33554483) (subtype a sa33554482) (subtype b sa33554482) (subtype a (ia33554436 c)) (subtype b (ia33554436 c)) (subtype a int3233554683) (subtype b int3233554683) (subtype c valuetype33554777) (subtype c valuetype33554777) (is_valuetype c) (default_constructor c)))))
(check-sat)
(get-model)
