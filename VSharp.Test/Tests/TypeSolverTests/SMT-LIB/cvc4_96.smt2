...
(assert(forall((a Type)) (not(subtype (array233554434 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype (icollection33555619 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype (ienumerable33555622 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype (ilist33555625 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype (ireadonlycollection33555626 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype (ireadonlylist33555627 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype (vector33554435 a) ih33554443))))
...
(assert(forall((a Type)) (not(subtype ih33554443 (array233554434 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (icollection33555619 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (icomparable33554521 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (ienumerable33555622 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (iequatable33554522 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (ilist33555625 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (ireadonlycollection33555626 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (ireadonlylist33555627 a)))))
(assert(forall((a Type)) (not(subtype ih33554443 (vector33554435 a)))))
...
(assert(not(subtype array33554517 ih33554443)))
...
(assert(not(subtype icloneable33554495 ih33554443)))
...
(assert(not(subtype icollection33555565 ih33554443)))
...
(assert(not(subtype ienumerable33555569 ih33554443)))
...
(assert(not(subtype ih33554443 array33554517)))
(assert(not(subtype ih33554443 icloneable33554495)))
(assert(not(subtype ih33554443 icollection33555565)))
(assert(not(subtype ih33554443 icomparable33554520)))
(assert(not(subtype ih33554443 iconvertible33554691)))
(assert(not(subtype ih33554443 ienumerable33555569)))
(assert(not(subtype ih33554443 iformattable33554672)))
(assert(not(subtype ih33554443 ilist33555573)))
(assert(not(subtype ih33554443 int3233554683)))
(assert(not(subtype ih33554443 istructuralcomparable33555577)))
(assert(not(subtype ih33554443 istructuralequatable33555576)))
...
(assert(not(subtype ilist33555573 ih33554443)))
...
(assert(not(subtype istructuralcomparable33555577 ih33554443)))
...
(assert(not(subtype istructuralequatable33555576 ih33554443)))
...
(assert(forall((a Type) (e Type) (c Type) (f Type) (d Type) (b Type)) (not (and (subtype a ih33554443) (subtype e ih33554443) (subtype c f) (subtype a f) (subtype d (vector33554435 b)) (subtype a b) (subtype c b) (subtype d (array233554434 int3233554683)) (not(subtype a b)) (not(subtype c b)) (not(subtype d (vector33554435 b))) (not(subtype d (array233554434 int3233554683)))))))
(check-sat)
(get-model)
