...
(assert(forall((b Type) (c Type) (d Type) (a Type)) (not (and (subtype b (tuple33554529 (tuple33554528 b) b)) (subtype c (tuple33554529 (tuple33554528 b) b)) (subtype b (tuple33554529 b d)) (subtype c (tuple33554529 b d)) (subtype (array233554434 int3233554683) a) (not(subtype (array233554434 int3233554683) a))))))
(check-sat)
(get-model)
