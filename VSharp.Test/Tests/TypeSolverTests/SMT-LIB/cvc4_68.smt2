...
(assert(forall((c Type) (a Type) (b Type)) (not (and (subtype c (ibox33554489 thing33554490)) (subtype a m33554470) (subtype b n33554471) (not(subtype a m33554470)) (not(subtype b n33554471))))))
(check-sat)
(get-model)
