...
(assert(forall((a Type) (b Type) (c Type)) (not (and (subtype a (tuple33554529 a b)) (subtype c (tuple33554529 a b)) (subtype a (tuple33554529 (tuple33554528 a) a)) (subtype c (tuple33554529 (tuple33554528 a) a))))))
(check-sat)
(get-model)
