...
(assert(forall((a Type) (c Type) (b Type) (d Type)) (not (and (not(subtype a (vector33554435 c))) (not(subtype b c)) (not(subtype d c)) (not(subtype a (array233554434 int3233554683)))))))
(check-sat)
(get-model)
