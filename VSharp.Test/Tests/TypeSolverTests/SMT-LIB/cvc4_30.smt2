...
(assert(forall((b Type) (d Type) (a Type) (c Type) (e Type) (f Type) (g Type) (h Type) (i Type) (j Type) (k Type)) (not (and (subtype b (ia33554436 d)) (subtype d (ia33554436 b)) (not(subtype valuetype33554777 a)) (not(subtype b (ia33554436 b))) (not(subtype c (ia33554436 b))) (not(subtype d (ia33554436 d))) (not(subtype e (ia33554436 d))) (not(subtype f b)) (not(subtype g b)) (not(subtype f h)) (not(subtype g h)) (not(subtype a h)) (not(subtype i h)) (not(subtype j h)) (not(subtype k h)) (default_constructor a) (is_reference j)))))
(check-sat)
(get-model)
